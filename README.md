...
Similar to ALG1 but:
The stepsize is set to 3 in the first 10 iterations, then 2.2 until the end of the second epoch, and is then computed using the Barzilai-Borwein rule as described in Algorithm 2 in [https://arxiv.org/abs/1605.04131](https://arxiv.org/abs/1605.04131), 
