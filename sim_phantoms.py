...
def pet_phantom(
    ...
    if type == -1:
        ...
        c0 = in_shape[0] // 2
        c1 = in_shape[1] // 2
        x_em[(c0 - 4) : (c0 + 4), (c1 - 4) : (c1 + 4), :] = 1.0

        x_em[28:32, c1 : (c1 + 4), :] = 2.5
        x_em[c0 : (c0 + 4), 20:24, :] = 2.5
        ...
        a = oversampled_shape[0] / 2.1  # semi-major axis
        b = oversampled_shape[1] / 3.5  # semi-minor axis
